...
public class DistributedLock implements Watcher {
    ...
    public void acquireLock() throws KeeperException, InterruptedException {
        ...
        if (smallestNode.equals(childPath)) {
            ...
            do {
                System.out.println("Lock is currentlyacquired by node " + smallestNode + " .. hencewaiting..");
    ...
    public void releaseLock() throws KeeperException, InterruptedException {
        if (!isAcquired) {
            throw new IllegalStateException("Lock needsto be acquired first to release");
        }
...
// Identify successful connection
                System.out.println("Successful connectedto the server");
                startFlag.countDown();
            }
        }
